...
Sales by Vehicle Model: A breakdown of sales performance by different car models. 
This information can guide inventory management and marketing efforts.  ''')

st.title('Sales Performance Dashboard Significant')
